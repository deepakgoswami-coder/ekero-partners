        ...
        <div class="content-body">
            ...
            <div class="group-header">
                <div class="row align-items-center">
                    <div class="col-md-6">
                         <a href="{{route('user.group.details')}}">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card chart-card">
            <div class="chart-card-header">
                ...
                <p class="chart-card-subtitle">Weekly contribution amounts over time</p>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row text-center">
                                       ...
                                       <div class="col-6 mb-4">
                                            <div class="stat-value text-success">{{ $member->group_sare ?? 'N/A' }}</div>
                                            <div class="stat-label">Number Of Share Per Week</div>
                                        </div>
                                    
                                    <div class="col-6 mb-4">
                                        <div class="stat-value text-warning">${{ $userContribution??0.00 }}</div>
                                        <div class="stat-label">Your Total Contribution</div>
                                    </div>
                                    <div class="col-6 mb-4">
                                            <div class="stat-value text-warning">${{ $group->target_amount ?? '' }}</div>
                                        <div class="stat-label">Group's Week Target</div>
                                    </div>
                                    <div class="col-6 mb-4">
                                        <div class="stat-value text-warning">${{ $groupContribution??0.00 }}</div>
                                        <div class="stat-label">Group Total Contributed</div>
                                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const contributionDates = @json(collect($contributionData)->pluck('date'));
    const contributionAmounts = @json(collect($contributionData)->pluck('total_amount'));

            ...
            <section class="mb-4">
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <h4 class="card-title mb-0 text-white">Your Group Details</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <!-- Portal Info -->
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="info-content">
                                        <div class="info-item">
                                            ...
                                            <span class="info-value">{{ $portal->name ?? 'N/A' }}</span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Start Date:</span>
                                            <span class="info-value">
                                                {{ $portal?->start_date ? \Carbon\Carbon::parse($portal->start_date)->format('d M Y') : 'N/A' }}
                                            </span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">End Date:</span>
                                            <span class="info-value">
                                                {{ $portal?->end_date ? \Carbon\Carbon::parse($portal->end_date)->format('d M Y') : 'N/A' }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="info-card">
                                    ...
                                    <div class="info-content">
                                        <div class="info-item">
                                            ...
                                            <span class="info-value">{{ $group->name ?? 'N/A' }}</span>
                                        </div>
                                        <div class="info-item">
                                            <span class="info-label">Group Number:</span>
                                            <span class="info-value">{{ $group->group_number ?? '0' }}</span>
                                        </div>
                                        <div class="info-item">
                        ...
                        @php
                            ...
                            // Default values set karein taaki niche error na aaye
                            $startDateStr = 'N/A';
                            $endDateStr = 'N/A';
                            $numberOfWeeks = 0;
                            $currentWeek = 0;

                            // Check karein ke portal null nahi hai
                            if ($portal && $portal->start_date && $portal->end_date) {
                                ...
                                // Total weeks calculation (Start se End tak)
                                $totalDiffDays = $startDate->diffInDays($endDate);
                                $numberOfWeeks = floor($totalDiffDays / 7);

                                // Current week calculation (Start se Aaj tak)
                                $daysSinceStart = $startDate->diffInDays($currentDate);
                                $currentWeek = ceil(($daysSinceStart + 1) / 7);
                            }
                        @endphp
                                ...
                                <div class="col-md-6 text-md-end">
                                    <div class="payment-action">
                                        <form action="{{ route('user.my.contribution.pay')}}" method="POST" class="d-inline-block">
                                            @csrf
                                            <input type="hidden" name="group_id" value="{{$group->id ?? '0'}}">
                    ...
                    <div class="card stat-card h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fw-bolder text-primary">
                                        ${{ number_format($group?->current_amount ?? 0, 2) }}
                                    </h3>
                            ...
                            <div class="progress mt-2" style="height: 6px;">
                                @php
                                    $progress = 0;
                                    if ($group && $group->target_amount > 0) {
                                        $progress = ($group->current_amount / $group->target_amount) * 100;
                                    }
                                @endphp
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fw-bolder text-info">
                                        ${{ number_format($group?->target_amount ?? 0, 2) }}
                                    </h3>
                ...
                <div class="col-lg-3 col-sm-6 mb-3">
                    <div class="card stat-card h-100">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fw-bolder text-success">${{ number_format($group->current_amount ?? 0, 2) }}</h3>
                            ...
                            <div class="d-flex justify-content-between">
                                <div>
                                    <h3 class="fw-bolder text-warning">
                                        ${{ number_format(($group?->target_amount ?? 0) * ($numberOfWeeks ?? 0), 2) }}
                                    </h3>
            ...
            <section class="mb-4">
                <div class="card">
                    <div class="card-header bg-secondary text-white">
                        <h4 class="card-title mb-0 text-white">My Contribution History</h4>
                    </div>

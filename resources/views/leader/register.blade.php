                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Register As Leader</h2>
                                <!-- <p class="card-text mb-2">Make your app management easy and fun!</p> -->
                                <form class="auth-register-form mt-2 row" action="{{ route('register.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <!-- Username -->
                                    ...
                                    <div class="mb-1 col-md-6">
                                     ...
                                     <!-- ID Proof Upload -->
                                    <div class="mb-1 col-md-6">
                                        <label class="form-label" for="register-idproof">Upload ID Proof</label>
                                        <input class="form-control" id="register-idproof" type="file" name="idproof" accept=".jpg,.jpeg,.png,.pdf" tabindex="7" />
                                        @error('idproof')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-1 col-md-4">
                                        ...
                                        <input class="form-control" id="register-mobile" type="tel" name="phone" placeholder="{00} 9876543210" aria-describedby="register-mobile" tabindex="4" />
                                        @error('phone')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-1 col-md-12">
                                        ...
                                        <textarea class="form-control" id="register-address" name="address" placeholder="Your full address" rows="2" tabindex="6"></textarea>
                                        @error('address')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>

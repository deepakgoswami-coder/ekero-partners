    ...
    <form action="{{ route('leader.bank.details') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-4">
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control" id="bankAddress" rows="3" name="bank_address" required>{{ $bankDetails->bank_address ?? "" }}</textarea>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select" id="accountType" name="account_type">
                    ...
                    <option value="business" {{ ($bankDetails->account_type ?? '') == 'business' ? 'selected' : '' }}>Business Account</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-12 mb-3">
                ...
                <textarea class="form-control" name="payment_details" id="additionalDetails" rows="4">{{ $bankDetails->payment_details ?? "" }}</textarea>
                <!-- <div class="example-text">Example: PayPal: your.email@example.com, or any other payment platforms you use</div> -->
                <div class="example-text">Example: Provide any additional payment information (e.g., PayPal email, other payment methods, special instructions)</div>
            </div>
        </div>

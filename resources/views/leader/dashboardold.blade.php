...
<div class="app-content content ">
        ...
        <div class="content-body">
            ...
            <div class="welcome-banner">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h1 class="welcome-title">Welcome back, {{ $leader->name}} 👋</h1>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="card stat-card stat-card-success">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <div class="stat-value">{{ $totalTarget ?? '0' }}</div>
    ...
    <!-- New row for Start Date and End Date cards -->
            ...
            <div class="card stat-card stat-card-info">
                <div class="card-body">
                    <div class="d-flex justify-content-center align-items-between">
                        <div>
                            <div class="stat-value">{{ $portalSet->start_date ? \Carbon\Carbon::parse($portalSet->start_date)->format('d M , y') : 'N/A' }}
                            </div>
                    ...
                    <div class="d-flex justify-content-center align-items-between">
                        <div>
                            ...
                            <div class="stat-trend trend-down">
                                <i data-feather="calendar"></i> Postal End
                            </div>
                        </div>

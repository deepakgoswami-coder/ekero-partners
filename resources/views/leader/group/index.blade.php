...
<style>
    ...
    .stat-icon {
        ...
        margin: 0 auto 1rem;
        /* background: rgba(255, 255, 255, 0.2); */
        background: rgb(242 243 255) !important;
        border-radius: 12px;
        display: flex;
        align-items: center;
            ...
            <div class="content-body">
                ...
                <div class="stats-summary">
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">{{ $groups->where('is_active', true)->where('portal_set_id', $groups->portal_set_id)->count() }}</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-value">${{ number_format($groups->where('is_active', true)->where('portal_set_id', $groups->portal_set_id)->sum('target_amount'), 2) }}</div>
                                    ...
                                    <div class="group-card-body">
                                        ...
                                        <div class="group-info-list">
                                            ...
                                            <div class="group-info-item">
                                                ...
                                                <span class="info-value">
                                                    {{ date('M d, Y', strtotime($portalSet->start_date)) }} - 
                                                    {{ date('M d, Y', strtotime($portalSet->end_date)) }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="inviteLink{{ $groups->id }}" class="form-control" readonly value="{{ route('user.register',['link' => $groups->invite_link]) }}">
                ...
                @else
                    <div class="empty-state">
                        ...
                        <a href="{{ route('leader.groups.create') }}" class="btn btn-primary mt-3 px-4 py-2">
                            <i data-feather="plus" class="me-2"></i>Create First Group
                        </a>
                    </div>
                @endif
                </div>

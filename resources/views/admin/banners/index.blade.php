                        ...
                        <div class="col-12">
                            <div class="card">
                              <table class="table table-bordered">
                                ...
                                <tbody>
                            @foreach ($banners as $key => $user)
                                <tr>
                                    <td>{{ $key+1 }}</td>
                                    <td><img src="{{ asset('uploads/'.$user->banner) }}" width="40px" alt=""></td>
                                    ...
                                    <td>
                                        <div>
                                            <a href="{{ route('banner.edit',$user->id) }}"><img width="20px" src="{{ asset('admin/icons/edit.png') }}" alt=""></a>
                                            <form action="{{ route('banner.destroy', $user->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this banner?')">
                                                @csrf
                                                @method('DELETE')

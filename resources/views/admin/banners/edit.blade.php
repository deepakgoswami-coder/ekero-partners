                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('banner.update', $banners->id) }}"
                                        ...
                                        <div class="row">
                                              <div class="col-lg-6 col-md-12 mb-1 mb-sm-0">
                                                ...
                                                @if ($banners->banner)
                                                <img src="{{ asset('uploads/'.$banners->banner) }}" style="width: 100px;" alt="">
                                                @endif
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-1 mt-1">
                                                    ...
                                                    <select class="form-select" name="category_id" id="basicSelect">
                                                        @foreach ($category as $val)
                                                            ...
                                                            <option @if ($val->id == $banners->category_id) selected @endif

                ...
                <div class="sidebar p-2">
                    ...
                    <div id="users-list">
                        <ul class="list-unstyled">
                            ...
                            @endforeach
                            @if($users->isEmpty())
                                <li class="text-center text-muted py-2">No users found</li>
                            @endif
                        </ul>
                    </div>
                </div>
            ...
            <div class="content-right flex-grow-1 d-flex flex-column" style="height:100%;">
                ...
                <div class="chat-header d-flex align-items-center border-bottom p-2" style="min-height:70px;">
                    <div class="avatar me-2">
                        <img id="chat-user-avatar" src="{{ asset('admin/icons/user.png') }}" height="50" width="50"
                ...
                <div class="chat-messages flex-grow-1 p-3 overflow-auto" id="chat-box" style="scroll-behavior:smooth; 
                ...
                <form id="chat-form" class="d-flex p-2 border-top align-items-center" style="background:#fff;">
                    ...
                    <input type="file" name="file" id="file" class="d-none"
                        accept=".jpg,.jpeg,.png,.gif,.webp,.pdf,.doc,.docx,.xls,.xlsx,.csv,.mp4,.mov,.mp3,.wav,.zip,.rar" />

                    <input type="text" name="message" id="message" class="form-control me-2 rounded-pill"
...
$(document).ready(function(){
    $("#chat-search").on("keyup", function() {
        ...
        $("#users-list .chat-user").filter(function() {

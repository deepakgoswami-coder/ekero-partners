        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                ...
                <div class="stats-summary">
                    <div class="stat-card">
                        <div class="stat-value">{{ $activeLeaders }}</div>
                        <div class="stat-label">Active Leaders</div>
                    </div>
                     <div class="stat-card">
                        <div class="stat-value">{{ $inactiveLeaders }}</div>
                ...
                <div class="leader-table-container">
                    <div class="table-header-custom">
                        <h4><i class="bi bi-people-fill me-2"></i>{{$coach->name}}'s Leaders </h4>
                    </div>
                        ...
                        <table class="table table-custom table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th>Leader Since</th>
                                    <th width="120">Coach chat</th>
                                    
                                </tr>
                            </thead>

                            <tbody>
                                @forelse ($leaders as $key => $val)
                                    <tr>
                                        <td class="fw-semibold">
                                            {{ $key + 1 + ($leaders->currentPage() - 1) * $leaders->perPage() }}
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{route('admin.coach.chat.access' ,[ 'coachId' => encrypt($coach->id), 'leaderId' => encrypt($val->id)]  ) }}">
                                    ...
                                    <tr>
                                        <td colspan="8">
                                            <div class="empty-state">
                                                ...
                                                <p>No Leaders Assign to Coach.</p>
                                            </div>
                                        </td>
                                    </tr>
                                @endforelse

                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="email" class="form-control" name="email"
                                                            placeholder="john@gmail.com" value="{{ $users->email ?? '' }}">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="phone_number"
                                                            placeholder="0909090909" value="{{  $users->phone_number ?? '' }}">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="language"
                                                            placeholder="English, Hindi" value="{{ $users->language ?? '' }}">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="state"
                                                            placeholder="State" value="{{ $users->state ?? '' }}">
                                                        @error('language') <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="city"
                                                            placeholder="city" value="{{ $users->city ?? '' }}">
                                                        @error('language') <small class="text-danger">{{ $message }}</small>
                                                        @enderror
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="time" class="form-control" name="time"
                                                            placeholder="English, Hindi" value="{{ $users->time ?? '' }}">
                                                ...
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <textarea class="form-control" name="bio" rows="3"
                                                            placeholder="Write something about yourself...">{{ $users->bio ?? '' }}</textarea>

                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" class="form-control" name="name" placeholder="Name" value="{{ $portal->name }}">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" class="form-control" name="total_portals" placeholder="Total Portal" value="{{ $portal->total_portals }}">

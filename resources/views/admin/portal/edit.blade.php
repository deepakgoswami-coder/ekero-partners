                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" step="0.01" class="form-control" id="target_amount" name="target_amount" placeholder="Enter target amount" value="{{ $portal->target_amount }}">
                                                        
                                                    </div>
                                                    <div class="form-text">Target amount is per week target</div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" step="0.01" class="form-control" id="number_of_shares" name="number_of_shares" value="{{ $portal->number_of_shares }}" >
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control" id="start_date" name="start_date" value="{{ old('start_date', $portal->start_date) }}">
                                                    </div>
                                                    <div class="form-text">Start date of the Portal</div>
                                                   @error('start_date') 
                                                        <div class="text-danger small mt-1">
                                                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                        </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" class="form-control" id="end_date" name="end_date" value="{{ old('start_date', $portal->end_date) }}">

                                                    </div>
                                                    <div class="form-text">End date is automatically calculated for one Year</div>
                                                    @error('end_date') 
                                                        <div class="text-danger small mt-1">
                                                            <i class="fas fa-exclamation-circle me-1"></i>{{ $message }}
                                                        </div>
...
@section('script')
    ...
    <script>
        ...
        // to calculate the share price based on the amt and numr of share 
        document.addEventListener('DOMContentLoaded', function () {

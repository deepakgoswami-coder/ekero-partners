                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{ route('groups.store') }}" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" class="form-control" name="contribution_amount" placeholder="Contribution Amount" value="{{ old('contribution_amount') }}">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="number" class="form-control" name="total_cycles" placeholder="Total Cycles" value="{{ old('total_cycles') }}">
                                            ...
                                            <div class="col-6">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="date" class="form-control" name="start_date" placeholder="Total Cycles" value="{{ old('start_date') }}">

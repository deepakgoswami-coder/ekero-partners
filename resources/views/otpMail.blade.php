            ...
            ">
                ...
                <tr>
                    <td style="color:#374151; font-size:15px; line-height:24px;">
                        ...
                        <p>
                            Thank you for signing up with <strong>Ekero Partners</strong>.
                        ...
                        <p>
                            ...
                            Please enter it on the verification screen to continue.
                        </p>

                        <!-- Security Notice -->
                        <p style="color:#6b7280; font-size:14px;">
                            🔒 <strong>Security notice:</strong><br>
                            Do not share this OTP with anyone. Ekero Partners will never ask you for your OTP over phone, email, or message.
                        </p>

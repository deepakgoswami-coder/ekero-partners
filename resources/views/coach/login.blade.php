...
@endif
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('coach.login.store') }}" method="POST">
                                    @csrf
                                    <div class="mb-1">
                                    ...
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                            <label class="form-label" for="login-password">Password</label><a href="{{route('coach.forget.password')}}"><small>Forgot Password?</small></a>
                                        </div>

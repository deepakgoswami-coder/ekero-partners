                ...
                <div class="row">
                            ...
                            <div class="profile-header text-center">
                                <div class="profile-image-container mx-auto">
                                    @if($user->profile_image)
                                        <img src="{{ asset('/uploads/' . $user->profile_image) }}" class="profile-avatar" alt="Profile Image" id="profile-avatar">
                                    @else
                                ...
                                <span class="badge bg-light mt-2 text-dark">Coach</span>
                            </div>
                            <div class="card-body">
                                <!-- <div class="d-grid">
                                ...
                                <div class="user-info">
                                    ...
                                    <div class="info-card">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <small class="text-muted">Coach Since</small>
                    ...
                    <div class="col-md-8">
                        <div class="card profile-card">
                            ...
                            <div class="card-body">
                                <form class="form form-vertical" action="{{ route('coach.update.profile') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 mt-4 pt-3 border-top">
                                            <button type="submit" class="btn btn-gradient text-white">
                                                <i data-feather="save" style="width: 16px; height: 16px;color:white"></i> Save Changes
                                            </button>
                                            <a href="{{ route('coach.dashboard') }}" class="btn btn-outline-secondary ms-2">

                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-6 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="mt-2 row" action="{{ route('coach.forget.password.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <p class="text-center mt-2"><a href="{{ route('coach.login') }}"><span>&nbsp;Back to Login</span></a></p>
...
$(document).ready(function() {
    $('#send-otp').on('click', function() {
        ...
        $.ajax({
            url: "{{ route('coach.send.otp.pass') }}",  // backend route
            type: "POST",
            data: {
                email: email,
                _token: "{{ csrf_token() }}"

                    ...
                    <img class="img-fluid" 
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Register As Coach</h2>
                                <!-- <p class="card-text mb-2">Make your app management easy and fun!</p> -->
                                <form class="auth-register-form mt-2" action="{{ route('coach.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-1">
                                ...
                                <p class="text-center mt-2"><span>Already have an account?</span><a href="{{ route("coach.login") }}"><span>&nbsp;Sign in instead</span></a></p>
...
$(document).ready(function() {
    $('#send-otp').on('click', function() {
        ...
        $.ajax({
            url: "{{ route('coach.send.otp') }}",  // backend route
            type: "POST",
            data: {
                email: email,
                _token: "{{ csrf_token() }}"

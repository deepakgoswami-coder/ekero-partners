...
<head>
    ...
    <title>Ekero Partners - Coach Dashboard</title>
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end notification-dropdown">
                        <li class="dropdown-menu-header">
                            <div class="dropdown-header d-flex justify-content-between align-items-center">
                                ...
                                @if($unreadCount > 0)
                                    <form action="{{ route('coach.notifications.markAllRead') }}" method="POST" class="m-0 p-0">
                                        @csrf
                ...
                <li class="nav-item dropdown dropdown-user">
                    <a class="nav-link dropdown-user-link dropdown-toggle" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none">
                            ...
                            <span class="user-status"><span class="badge bg-primary">Coach</span>
                            </span>
                        </div>
                        <span class="avatar">

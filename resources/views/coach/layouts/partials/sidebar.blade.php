...
.main-menu .navbar-header .navbar-brand.p-0 {
    display: flex
;
    align-items: center;
...
<aside class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header p-0 ps-1">
        <ul class="nav navbar-nav flex-row align-items-center">
            <li class="nav-items me-auto mb-0">
                <a class="navbar-brand p-0 mb-0 m-0" href="{{ route('coach.dashboard') }}">
                    <div class="brand-logo">
                        <img src="{{ asset('images/ekeroLogo.png') }}"  alt="Ekero Partners" class="brand-image" width="">
                        <span class="brand-text">Coach Portal</span>
                    </div>
                </a>
            </li>
    ...
    <div class="main-menu-content mt-2 px-2">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <!-- Dashboard -->
            <li class="nav-item">
                <a class="d-flex align-items-center {{ request()->routeIs('coach.dashboard') ? 'active' : '' }}"
            ...
            <!-- Leader list -->
            <li class="nav-item">
                <a class="d-flex align-items-center {{ request()->routeIs('coach.leader.list') ? 'active' : '' }}"
                href="{{ route('coach.leader.list') }}">
                    <div class="menu-icon-wrapper">
            ...
            <li class="nav-item">
                <a class="d-flex align-items-center {{ request()->routeIs('coach.calender.index') ? 'active' : '' }}"
                href="{{ route('coach.calender.index') }}">
                    <div class="menu-icon-wrapper">
                        <i data-feather="message-square" class="menu-icon ms-1"></i>
                    </div>Calendar
                </a>
            ...
            <!-- Group Chat -->
            <li class="nav-item">
                <a class="d-flex align-items-center {{ request()->routeIs('coach.groups.chat') ? 'active' : '' }}"
                href="{{ route('coach.chat.leaderList') }}">
                    <div class="menu-icon-wrapper">
                        <i data-feather="message-square" class="menu-icon ms-1"></i>
                    </div>
            ...
            <!-- <li class="nav-item">
                ...
                href="#">
                    ...
                    <span class="menu-title text-truncate">Reciepts</span>
                    <span class="menu-badge badge bg-light-warning">Download</span>
                </a>
            </li> -->
        {{--
...
<!-- Help Modal -->
<aside class="modal fade" id="helpModal" tabindex="-1" aria-labelledby="helpModalLabel" aria-hidden="true">
        ...
        if (event.altKey) {
            switch(event.key) {
                case '1':
                    ...
                    break;
                case '2':
                    window.location.href = "{{ route('coach.chat.leaderList') }}";
                    break;
                case '3':
